...
#EMOTES BY DEKAPROCODE1STVIETNAM
# FIXED BY DEKA
...
async def handle_badge_command(cmd, inPuTMsG, uid, chat_id, key, iv, region, chat_type):
    ...
    try:
        ...
        success_msg = f"[B][C][00FF00]✅ Hoàn Tất\n"
            ...
            while True:
                ...
                if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                    try:
                        ...
                        message = f'[B][C]Tất Cả Tránh Ra [00ffd4] Bố [C][B][007AFF]D[C][B][339BFF]E[C][B][66BBFF]K[C][B][99DFFF]A[C][B][CCF5FF]D[C][B][E0FAFF]E[C][B][F0FDFF]V [FFFFFF]Đã Vào!\n\n[FFFFFF]× Tiktok: [00ffb3]@dekadev0\n[FFFFFF]× Tel[c]egr[c]am: [00ffb3]@dekadevz\n[FFFFFF]× Facebook: [00ffb3]Duy Khanh\n\nDuy Khanh:\n[C0C0C0]Mọi Người Th[c]uê Bot I[c]b t[c]e[c]l[c]e nhé!'
                ...
                if data.hex().startswith("1"):
                    ...
                    if response:
                        if inPuTMsG.startswith(("/5")):
                            ...
                            # SUCCESS MESSAGE
                            success_message = f"[B][C][00FF00]✅ SUCCESS! Đã Gửi Lời Mời Tới {uid}!\n"
                        ...
                        if inPuTMsG.startswith('/join '):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # SUCCESS MESSAGE
                                    success_message = f"[B][C][FFFFFF]✅ Vào Đội Thành Công!!\n"
                                    await safe_send_message(response.Data.chat_type, success_message, uid, chat_id, key, iv)
...
[C][B]Thuê Vui Lòng Ib [ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """[C][B][FFFFFF]Quê: Lâm Đồng
[FFFFFF]Skills: JAVA-PYTHON-LUA 
[FFFFFF]Tên: Nguyễn Duy Khánh
[FFD700]TIK: [FFFFFF]@dekadev0
[FFD700]T[c]e[c]l[c]e:@dekadevz
[FFD700]FB: [FFFFFF] Duy Khanh
[FFD700]Developer —͟͞͞ </> DEKA"""
                        ...
                        if inPuTMsG.strip().startswith('/siv'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # SUCCESS MESSAGE
                                    success_msg = f"[B][C][00ff00]『 ACTIVE 』[ffffff]|Bắt Đầu Spam Mời\n[00ffb3]Uid Bị Spam: [FFFFFF]{target_uid}\n[ffffff]Te[c]le[c]gram: [00fffb]@dekadevz"
                                    await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
...
# ===== XỬ LÝ CHAT MESSAGE =====
                        if inPuTMsG and inPuTMsG.strip().startswith(('/start', 'hello', 'hi' , 'menu' , '/menu' , 'bot' , 'ê' , 'start' , 'ơi' , 'oi' , 'on' , 'help')):
                            try:
                                ...
                                welcome_msg = (
                                    ...
                                    "[C][B][32CD32]/help[/b]\n\n"
                                    "[C][B][00ffb3]DEKA:[/b]\n"
                                    "[C][B][C0C0C0]Th[c]uê Bot I[c]B [c]Te[c]le[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz[/b]\n\n"
                                    "[FF0000][c]━━━━━━━━━━━━━━━━━━━━[/c]"
                                )
                        ...
                        if inPuTMsG.strip().startswith('/ftg'):
                            ...
                            message = (
                                ...
                                "[ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"
                            )
                        ...
                        if inPuTMsG.strip().startswith('/rd'):
                            try:
                                ...
                                msg = (
                                    f"[B][C][00ff00]『 ACTIVE 』[ffffff]| Đang Join TeamCode {teamcode}\n"
                                    "[ffffff]Chế độ: [00ffb3]Full Hành Động LV7!\n"
                                    "[ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"
                                 )
                                P = await SEndMsG(response.Data.chat_type, msg, uid, chat_id, key, iv)
                                await SEndPacKeT(whisper_writer, online_writer, 'ChaT', P)
                                ...
                                async def emote_for_uid(uid_target):
                                    try:
                                        ...
                                        done_msg = (
                                            f"[B][C][FFD700][B]Thành Công\n"
                                            f"[FFFFFF]Team: [00fffb]{teamcode}\n"
                                            f"[FFFFFF]Số Emote: [00fffb]{len(full_emotes)}\n"
                                            f"[ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"
                                        )
                                        D = await SEndMsG(response.Data.chat_type, done_msg, uid, chat_id, key, iv)
                                        await SEndPacKeT(whisper_writer, online_writer, 'ChaT', D)
                                    except Exception as e:
                        ...
                        if inPuTMsG.strip().startswith('/co2'):
                            try:
                                ...
                                msg = (
                                    f"[B][C][00ff00]『 ACTIVE 』[ffffff]| Đang Join TeamCode {teamcode}\n"
                                    "[ffffff]Chế độ: [00ffb3]Full Hành Động Cổ!\n"
                                    "[ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"
                                 )
                                P = await SEndMsG(response.Data.chat_type, msg, uid, chat_id, key, iv)
                                await SEndPacKeT(whisper_writer, online_writer, 'ChaT', P)
                        ...
                        if inPuTMsG.strip().startswith('/wf'):
                            try:
                                ...
                                msg = (
                                    f"[B][C][00ff00]『 ACTIVE 』[ffffff]| Đang Join TeamCode {teamcode}\n"
                                    "[ffffff]Chế độ: [00ffb3]Random Full Hành Động Lv7!\n"
                                    "[ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"
                                )
                                P = await SEndMsG(response.Data.chat_type, msg, uid, chat_id, key, iv)
                                await SEndPacKeT(whisper_writer, online_writer, 'ChaT', P)
                        ...
                        if inPuTMsG.strip().startswith('/l'):
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    msg = (
                                    f"[B][C][00ff00]『 ACTIVE 』[ffffff]| Đang Tiến Hành Bật Hành Động\n"
                                    "[ffffff]Chế độ: [00ffb3]Random Ful Hành Động Lv7!\n"
                                    "[ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"
                                 )
                                    P = await SEndMsG(response.Data.chat_type, msg, uid, chat_id, key, iv)
                                    await SEndPacKeT(whisper_writer, online_writer, 'ChaT', P)
                        ...
                        if inPuTMsG.strip().lower() in ("/help"):
                            print(f"Help command detected from UID: {uid} in chat type: {response.Data.chat_type}")
    
                            # Header
                            header = """[B][C][FFFFFF]ĐÂY LÀ DANH SÁCH LỆNH BOT"""
    
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
    
                            # Advanced Commands
                            advanced_commands = """[B][C]
                
[FFFFFF]»› [00FFF7]Bật Hành Động Cổ
[FFFFFF]=> [00FF00]/[FFFFFF]🗿sr [ teamcode ] [ UID ]

[FFFFFF]»› [00FFF7]Random Hành Động
[FFFFFF]=> [00FF00]/[FFFFFF]🗿riv [ teamcode ] [ UID ] [ UID2 ]...

[FFFFFF]»› [00FF62]Bật Hành Động Chưa Ra Mắt
[FFFFFF]=> [00FF00]/[FFFFFF]🗿sf [ teamcode ] [ UID ]

[FFFFFF]»› [00FF62]Spam Hành Động
[FFFFFF]=> [00FF00]/[FFFFFF]🗿fast [ UID ]

[FFFFFF]»› [00FF62]Vô Nhóm Bật Hành Động Rồi Out
[00ff00]/ftg [teamcode] [namegun1] [uid1] [namegun2] [uid2] ...

[FFFFFF]»› [00FFA6]Sau Đây Là Lệnh Spam

[FFFFFF]»› [00FFA6]Spam Tin Nhắn
[FFFFFF]=> [00FF00]/🗿msg [TeamCode] [nội dung] [số lần]
[B][C][ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"""
                            ...
                            evo_commands = """[B][C]
[FFFFFF]»› [00FFA6]Spam Ghost
[FFFFFF]=> [00FF00]/[FFFFFF]🗿Ghost [TeamCode] [Tên Ghost]

[FFFFFF]»› [00FFA6]Spam Phòng
[FFFFFF]=> [00FF00]/[FFFFFF]🗿spr [Id Chủ Phòng] [Id Phòng]

[FFFFFF]»› [00FFA6]Spam Lag
[FFFFFF]=> [00FF00]/[FFFFFF]🗿Vip [TeamCode]

[FFFFFF]»› [00FFA6]Spam Phòng Vip
[FFFFFF]=> [00FF00]/[FFFFFF]🗿wrt [Id Phòng] [Mật Khẩu Phòng]

[FFFFFF]»› [00FFA6]Spam Yêu Cầu Đội
[FFFFFF]=> [00FF00]/[FFFFFF]🗿xjoin [id]

[FFFFFF]»› [00FFA6]Ghost Team:))
[FFFFFF]=> [00FF00]/[FFFFFF]🗿Ghost [Teamcode]

[ff0000]Lưu ý: [C0C0C0]Nếu Muốn Nhiều Người Bật Cùng Thì Chỉ Cần Thêm UID Vô Và Nhớ Bỏ [FFFFFF][ ] [C0C0C0]ra nhé"""
    
                            await safe_send_message(response.Data.chat_type, evo_commands, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            # Evolution Emote Commands
                            code_commands = """[B][C][00FF00]Lệnh Hành Động Bằng Code
[B][C][FFFFFF]»› [00FF62]Bật Hành Động Theo Tên + Exit
[FFFFFF]=> [00FF00]/[FFFFFF]🗿ftg [CODE] [NAMEGUN] [UID]
[B][C][FFFFFF]»› [00FF62]Join Code Bật Full Hành Động Lv7
[FFFFFF]=> [00FF00]/[FFFFFF]🗿rd [TeamCode] [UID]
[B][C][FFFFFF]»› [00FF62]Join Code RanDom Full Hành Động Lv7
[FFFFFF]=> [00FF00]/[FFFFFF]🗿wf [TeamCode] [UID]
[B][C][ffffff]Tele[c]gr[c]am: [C][B][007AFF]@[C][B][339BFF]d[C][B][66BBFF]e[C][B][99DFFF]k[C][B][CCF5FF]a[C][B][E0FAFF]d[C][B][F0FDFF]evz"""
                           ...
                           # Badges command 
                            badge_commands = """[C][B][FFFFFF]Lệnh Spam Xin Vào Đội + Tích
[C][B][00FF00]/s1 [uid] 
-> [FFFFFF]Tích Nhà Sáng Tạo
[C][B][00FF00]/s2 [uid] 
-> [FFFFFF]Tích V v2
[C][B][00FF00]/s3 [uid] 
-> [FFFFFF]Tích Nhà Điều Hành
[C][B][00FF00]/s4 [uid] 
-> [FFFFFF]Tích V v1
[C][B][00FF00]/s5 [uid] 
-> [FFFFFF]Tích Pro
...
async def MaiiiinE():
    Uid , Pw = '4341908700','deka_DV7F5_BY_SPIDEERIO_GAMING_Y173I'
